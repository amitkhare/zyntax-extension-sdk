...
export const EXTENSION_HOST_API_METHODS = Object.freeze({
  ...
  "processes.execute": Object.freeze(["prepare", "open", "send", "observe", "stop", "release", "sessions"] as const),
  editor: Object.freeze(["context", "replaceMarkers", "observe", "reveal", "resolvePath", "save"] as const),
  "extensions.manage": Object.freeze(["query", "inspect", "requestInstall"] as const),
  "workspace.read": Object.freeze(["snapshot", "listDirectory", "relativePath", "readText", "readTextIfExists", "findFiles"] as const),
  "workspace.write": Object.freeze(["writeText", "applyEdits"] as const),
...
export const EXTENSION_HOST_API_INTERACTIVE_METHODS = Object.freeze([
  ...
  "debug.execute:selectPath", "debug.execute:prepare", "processes.execute:prepare", "processes.execute:open",
  "processes.execute:observe", "editor:observe", "editor:save", "workspace.write:writeText",
